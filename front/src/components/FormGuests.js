    ...
    render() {
        return (
                <form className="FlexContainerGuests" onSubmit={this.handleSubmitFormGuest} method="POST" action='/api/guests'>
                    ...
                    <input className="inputForm" name="compteG" type="text" onChange={this.handleChangeInputForm} value={this.state.compteG} placeholder="Votre compte Instagram / Facebook / autres :"></input>
