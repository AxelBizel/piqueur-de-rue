...
export default function Agency() {
    return (
        <div className="SectionContainer">
            ...
            <CarrouselAgency />
            <p className="aboutAgency">Conçu comme une agence de design, le tattoo shop PIQUEUR DE RUE se veut être à l'écoute des clients et offrir un suivi de qualité.
